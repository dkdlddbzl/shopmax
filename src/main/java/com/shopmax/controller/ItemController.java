...
public class ItemController {
	...
	public String itemshop(Model model, ItemSearchDto itemSearchDto
			, Optional<Integer> page) {
		Pageable pageable = PageRequest.of(page.isPresent() ? page.get() : 0, 6); // of(조회 할 페이지의 번호, 한페이지당 조회할 데이터 갯수)
